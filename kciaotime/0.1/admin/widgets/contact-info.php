...
function kciao_contact_info_widget()
{
	register_widget('kciao_contact_info_widget');
}

class kciao_contact_info_widget extends WP_Widget {
	...
	function kciao_contact_info_widget()
	{
		...
		$this->WP_Widget('contact_info-widget', 'Kciao :: Contact Info', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance)
	{
		...
		<p class="phone"><?php _e('Phone:', 'kciao'); ?> <?php echo $instance['phone']; ?></p>
		<?php endif; ?>

		<?php if($instance['mobile']): ?>
		<p class="mobile"><?php _e('Mobile:', 'kciao'); ?> <?php echo $instance['mobile']; ?></p>
		<?php endif; ?>

		<?php if($instance['fax']): ?>
		<p class="fax"><?php _e('Fax:', 'kciao'); ?> <?php echo $instance['fax']; ?></p>
		<?php endif; ?>

		<?php if($instance['email']): ?>
		<p class="email"><?php _e('Email:', 'kciao'); ?> <a href="mailto:<?php echo $instance['email']; ?>"><?php if($instance['emailtxt']) { echo $instance['emailtxt']; } else { echo $instance['email']; } ?></a></p>
		<?php endif; ?>

		<?php if($instance['web']): ?>
		<p class="web"><?php _e('Web:', 'kciao'); ?> <a href="<?php echo $instance['web']; ?>"><?php if($instance['webtxt']) { echo $instance['webtxt']; } else { echo $instance['web']; } ?></a></p>
		<?php endif; ?>
		</div>
		<?php
		echo $after_widget;
...
add_action('widgets_init', 'kciao_contact_info_widget');
