...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'kciao' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'kciao' ),
		'repeat-y'  => __( 'Repeat Vertically', 'kciao' ),
		'repeat'    => __( 'Repeat All', 'kciao' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'kciao' ),
		'top center'    => __( 'Top Center', 'kciao' ),
		'top right'     => __( 'Top Right', 'kciao' ),
		'center left'   => __( 'Middle Left', 'kciao' ),
		'center center' => __( 'Middle Center', 'kciao' ),
		'center right'  => __( 'Middle Right', 'kciao' ),
		'bottom left'   => __( 'Bottom Left', 'kciao' ),
		'bottom center' => __( 'Bottom Center', 'kciao' ),
		'bottom right'  => __( 'Bottom Right', 'kciao')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'kciao' ),
		'fixed'  => __( 'Fixed in Place', 'kciao' )
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'kciao' ),
		'italic'      => __( 'Italic', 'kciao' ),
		'bold'        => __( 'Bold', 'kciao' ),
		'bold italic' => __( 'Bold Italic', 'kciao' )
		);
